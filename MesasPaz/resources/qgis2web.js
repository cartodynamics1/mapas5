...
map.getView().fit([-13248325.298891, 1635642.089528, -9290901.365531, 3982201.835073], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Regiones Mesas de Paz</h2>';
        return titleElement;
    })(),
